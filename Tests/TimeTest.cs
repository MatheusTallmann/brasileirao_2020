...
namespace Tests
{
    ...
    {
        public User GenerateUser(int choice)
        {
        ...
        [Fact]
        public void Shouldnt_Create_Team_If_Have_Less_Then_16_Players()
        {
            // Dado / Setup
            var campeonato = new Campeonato();
            ...
            var jogadoresCorinthians = new List<Jogador>{Corinthians1,Corinthians2,Corinthians3,Corinthians4,Corinthians5,Corinthians6,Corinthians7,
            Corinthians8,Corinthians9,Corinthians10};

            var Corinthians = new Time("Corinthians", GenerateUser(1));
            
            // Quando / Ação
            var time = Corinthians.CriarJogadores(jogadoresCorinthians);
